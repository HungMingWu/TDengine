...
static thread_local SExceptionNode* expList;
...
static void cleanupWrapper_int_ptr( SCleanupAction* ca ) {
    int (*func)( void* ) = (int (*)(void*))ca->func;
    func( ca->arg1.Ptr );
}
