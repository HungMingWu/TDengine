...
extern void *destroyCreateTableSql(SCreateTableSQL *pCreate);
...
{
  SCreateTableSQL* pCreateTable = (SCreateTableSQL*)calloc(1, sizeof(SCreateTableSQL));
  pCreateTable->childTableInfo = (SArray*)taosArrayInit(4, sizeof(SCreatedTableInfo));
...
{taosArrayPush(yymsp[-2].minor.yy421, &yymsp[0].minor.yy183); yylhsminor.yy421 = yymsp[-2].minor.yy421;  }
  yymsp[-2].minor.yy421 = yylhsminor.yy421;
      ...
      {yylhsminor.yy421 = (SArray*)taosArrayInit(4, sizeof(TAOS_FIELD)); taosArrayPush(yylhsminor.yy421, &yymsp[0].minor.yy183);
      }
